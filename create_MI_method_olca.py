...
overburden_list = [
  ...
  #Copper
  ["gold mine operation and refining | copper, cathode",687],
  ["platinum group metal mine operation, ore with high palladium content | copper, cathode |", 687],
  ["copper production, cathode, solvent extraction and electrowinning process | copper, cathode",687],
  #Copper concentrate
  ["copper mine operation and beneficiation, sulfide ore | copper concentrate, sulfide ore",150.2],
  ["gold-silver mine operation and beneficiation | copper concentrate, sulfide ore",150.2],
  ["molybdenite mine operation | copper concentrate, sulfide ore",150.2],

  #Gold
  ["silver-gold mine operation with refinery | gold",1977787.9],
  ["gold mine operation and gold production, unrefined | gold, unrefined",1977787.9],
  ["gold mine operation and refining | gold",1977787.9],
  ["gold-silver mine operation with refinery | gold",1977787.9],
  ["gold production | gold",1977787.9],

  #Silver
  ["gold mine operation and refining | silver",56132.2],
  ["gold-silver mine operation with refinery | silver",56132.2],
  ["silver-gold mine operation with refinery | silver",56132.2],
  ["silver mine operation with extraction | silver, unrefined",56132.2],

  #Lead
  ["gold mine operation and refining | lead",10.7],
  #Lead concentrate
  ["gold-silver mine operation and beneficiation | lead concentrate",5.7],
  ["silver mine operation with extraction | lead concentrate",5.7],

  #Molybdenite
  ["copper mine operation and beneficiation, sulfide ore | molybdenite",2211.3],
  ["molybdenite mine operation | molybdenite",2211.3],

  #Zinc
  ["gold mine operation and refining | zinc",43.7],
  #Zinc concentrate
  ["gold-silver mine operation and beneficiation | zinc concentrate",22.8],
  ["silver mine operation with extraction | zinc concentrate",22.8]]
...
# Therefore corresponding values for gangue are retrived from the global mining database as well.
...
gangue_list = [
  ...
  # Iron
  ["iron ore mine operation and beneficiation | iron ore concentrate |",0.4995],
  ["iron ore mine operation, 46% Fe | iron ore, crude ore, 46% Fe |",63/46 * 0.4995],
...
missing_overburden.sort()
missing_gangue.sort()
missing_outside.sort()
